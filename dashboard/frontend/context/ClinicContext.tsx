...
export function ClinicProvider({ children }: { children: ReactNode }) {
  ...
  const refresh = async () => {
    ...
    try {
      ...
      if (!currentUser) {
        ...
        console.log(
          "ClinicContext: getUser (verified) user:",
          currentUser?.email || "null",
        );
      }
      ...
      if (clinicError || !clinicData) {
        ...
        if (docError)
          console.error("ClinicContext: Doctors fetch error:", docError);
  ...
  return (
    <ClinicContext.Provider
      value={{ clinic, doctors, loading, user, refresh, signOut }}
    >
      {children}
    </ClinicContext.Provider>
  );
