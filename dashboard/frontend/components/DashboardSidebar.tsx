...
export default function DashboardSidebar({
  ...
  const quickActions = [
    {
      ...
      href: buildDoctorUrl("/portal/doctor-dashboard/queue"),
    },
    {
      label: "Patient Hub",
      icon: (
      ...
      href: buildDoctorUrl("/portal/doctor-dashboard/patients"),
    },
    {
      ...
      href: buildDoctorUrl("/portal/digital-prescription"),
    },
    ...(!isReceptionist
      ? [
          {
  ...
  const frontDeskActions = [
    ...
    },
    {
      ...
      href: "/portal/front-desk/analytics",
    },
  ];
