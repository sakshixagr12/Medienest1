...
function parseHSL(hslStr: string) {
  ...
  if (!match) return { h: 200, s: 80, l: 80 }; // Fallback to clinical blue
...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  className = '',
  edgeSensitivity = 30,
  glowColor = '200 80 80', // Sapphire clinical blue default HSL
  ...
  coneSpread = 25,
  animated = false,
  colors = ['#3b82f6', '#14b8a6', '#6366f1'], // Medical blue/teal/indigo gradient
  fillOpacity = 0.5,
}) => {
    ...
    const runSweep = () => {
      ...
      animateValue({ ease: easeInCubic, delay: 2500, duration: 1500, start: 100, end: 0,
        ...
        onEnd: () => {
          ...
          if (isActive) setTimeout(runSweep, 2000); // Loop every 2 seconds
        },
      });
    };
