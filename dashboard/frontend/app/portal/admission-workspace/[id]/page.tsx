        ...
        <div className={styles.rightColumn}>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.quickActions}>
              <Link 
                href={`/portal/admission-record?draftId=${record.id}&patientId=${record.patient_id || ""}`} 
              ...
              {record.status?.toUpperCase() === "ADMITTED" ? (
                <Link 
                  href={`/portal/discharge-summary?admissionId=${record.id}&patientId=${record.patient_id || ""}`} 
              ...
              <Link 
                href={`/portal/admission-record/view?id=${record.id}`} 
                target="_blank"
