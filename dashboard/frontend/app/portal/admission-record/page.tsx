          ...
          <div className={styles.stickyPatientHeader}>
            <div className={styles.stickyPatientInner}>
              ...
              {((summary.allergies || "").trim() ||
                ...
                summary.has_thyroid) && (() => {
                const flags: string[] = [];
                const allergyStr = (summary.allergies || "").trim();
                        ...
                        <div className={styles.mainColumn}>
                          ...
                          <div className={styles.summaryCard}>
                            ...
                            {(!searchParams.get("patientId") && !isNewPatientMode && !summary.patientId) ? (
                              ...
                              <button type="button" className={styles.btnRegisterNew} onClick={() => setIsNewPatientMode(true)} style={{ height: 46, whiteSpace: 'nowrap', flexShrink: 0, marginTop: 24 }}>
