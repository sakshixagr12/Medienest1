      ...
      <main className={styles.main}>
        <div className={styles.header}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            ...
            <Link href="/portal/admission-record" className={styles.btnPrimary}>
              + New Admission
            </Link>
          </div>
        </div>
                            ...
                            <td>
                              <div className={styles.actionsContainer}>
                                <button
                                  ...
                                  onClick={() => router.push(`/portal/admission-record/view?id=${record.id}`)}
                                >
                                  View
                                </button>
                                <button
                                ...
                                <button
                                  className={styles.btnAction}
                                  onClick={() => router.push(`/portal/discharge-summary?admissionId=${record.id}&patientId=${record.patient_id}`)}
                                >
                                  Create Discharge
                                </button>
                              </div>
