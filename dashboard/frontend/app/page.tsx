        ...
        <div className="container">
          ...
          <div className="hero-grid-features">
            <div className="feature-item-mini">
              <div className="mini-icon-circle"><Sparkles size={18} /></div>
              <h5>AI-Powered Notes</h5>
              <p>Auto-generate clinical notes &amp; summaries</p>
            </div>
            ...
            <div className="feature-item-mini">
              ...
              <p>Share prescriptions &amp; reminders instantly</p>
            </div>
            ...
            <div className="feature-item-mini">
              ...
              <p>Create, sign &amp; send in seconds</p>
            </div>

            <div className="feature-divider" />

            <div className="feature-item-mini">
              <div className="mini-icon-circle"><ShieldCheck size={18} /></div>
              <h5>Secure &amp; Compliant</h5>
              <p>100% secure, encrypted &amp; HIPAA ready</p>
            </div>
            ...
            <div className="feature-item-mini">
              ...
              <p>Access your clinic from anywhere, anytime</p>
            </div>

            <div className="feature-divider" />

            <div className="feature-item-mini">
              <div className="mini-icon-circle"><TrendingUp size={18} /></div>
              <h5>Beautiful Reports</h5>
              <p>Visual insights for better decision making</p>
            </div>
          </div>
