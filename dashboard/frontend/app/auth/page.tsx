                ...
                {authLoading ? (
                  ...
                  <>
                    <svg viewBox="0 0 48 48" width="20" height="20" xmlns="http://www.w3.org/2000/svg" style={{ marginRight: '10px' }}>
                      ...
                      <path fill="#ffffff" d="M46.5 24c0-1.55-.15-3.24-.47-4.5H24v9h12.75C35.2 31.84 32.83 34 29.84 35.63l7.98 6.19C42.5 37.84 46.5 31.62 46.5 24z"/>
                      <path fill="#ffffff" d="M24 38.5c-6.26 0-11.57-4.22-13.46-9.91l-7.98 6.19C6.51 42.62 14.62 48 24 48c6.47 0 11.93-2.13 15.89-5.81l-7.9-6.12C29.93 37.56 27.15 38.5 24 38.5z"/>
                      <path fill="#ffffff" d="M10.54 28.59c-.48-1.45-.76-2.99-.76-4.59s.27-3.14.76-4.59l-7.98-6.19C.92 16.46 0 20.12 0 24s.92 7.54 2.56 10.78l7.98-6.19z"/>
                    </svg>
