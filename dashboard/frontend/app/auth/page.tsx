          ...
          <div className={styles.panelContent}>
            <header className={styles.brandHeader}>
              <div className={styles.logoCircle}>
                <Image src="/assets/medinest_logo.png" alt="MediNest Logo" width={48} height={48} style={{ objectFit: 'contain' }} />
              </div>
              <h1>MediNest</h1>
            ...
            <div className={styles.welcomeInfo}>
              ...
              <p>Sign in or create a new account using your Google account to manage your patients, clinical queues, and AI recommendations.</p>
            </div>
            ...
            >
              {authLoading ? (
                <span className="spinner" style={{ width: '20px', height: '20px', borderTopColor: 'var(--sanctuary-primary)' }} />
              ) : (
                <>
