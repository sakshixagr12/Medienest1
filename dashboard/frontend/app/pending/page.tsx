  ...
  const checkStatus = async () => {
    ...
    try {
      ...
      if (clinic?.status === "active") {
        ...
        setStatusMsg({
          type: "pending",
          text: "⏳ Still under review. Check back later.",
        });
      }
    } catch (e: any) {
      ...
      setStatusMsg({
        type: "pending",
        text: "Error: " + (e.message || "Verification failed"),
      });
    }
    setChecking(false);
  };
    ...
    <div className={styles.bg}>
      <div className={styles.card}>
        ...
        <p className={styles.sub}>
          Your clinic registration has been received. Our team is reviewing it
          and will approve your account shortly.
        </p>
        ...
        <div className={styles.actions}>
          ...
          {statusMsg && (
            <div
              className={`${styles.statusMsg} ${statusMsg.type === "approved" ? styles.statusApproved : styles.statusPending}`}
            >
              {statusMsg.text}
            </div>
          )}
          <button className={`${styles.btn} ${styles.btnOut}`} onClick={logout}>
            Sign Out
          </button>
        </div>
      </div>
