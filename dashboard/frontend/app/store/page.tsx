    ...
    <>
      ...
      <div className={styles.page}>
        ...
        <main className={styles.selectionShell} style={{ gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "24px" }}>
          <Link href="/store/billing-receipts" className={styles.portalCardLarge}>
          ...
          <Link href="/store/day-summary" className={styles.portalCardLarge}>
            <div className={styles.cardContent}>
          ...
          <Link href="/store/clinic-settings" className={styles.portalCardLarge}>
            <div className={styles.cardContent}>
