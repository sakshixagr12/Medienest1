...
export default function BillingPage() {
  ...
  const handleSave = async () => {
    ...
    if (!clinic?.id) {
      alert(
        "Clinic information not loaded. Please wait for the page to fully load.",
      );
      return;
    }
    ...
    try {
      ...
      const receiptData = {
        ...
        items_json: JSON.stringify(
          items.map((it) => ({ desc: it.name, qty: it.qty, amt: it.price })),
        ),
      ...
      const response = await authenticatedFetch(
        `${API_BASE_URL}/api/analytics/receipts`,
        {
          method: "POST",
      ...
      alert(
        "Failed to save receipt: " +
          (err.message || "Check backend connection."),
      );
    } finally {
      setIsSaving(false);
    }
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.formPanel}>
            <div className={styles.panelBlock}>
                    ...
                    {ptSuggestions.map((pt) => (
                      ...
                      >
                        ...
                        <div className={styles.suggestionMeta}>
                          {pt.contact} &middot; {pt.age ? `${pt.age}Y` : ""}{" "}
                          &middot; {pt.gender}
                        </div>
                      </div>
                    ))}
              ...
              <div className="field">
                <label>{clinic?.clinic_type === "store" ? "Prescribing Doctor" : "Consulting Doctor"}</label>
            ...
            <div className={styles.receiptCard} id="receipt-preview">
              ...
              <div className={styles.rcptInfo}>
                <div className={styles.rcptRow}>
                  <span>Patient:</span> <b>{name || "(Not entered)"}</b>
                </div>
                <div className={styles.rcptRow}>
                  <span>Age/Sex:</span>{" "}
                  <b>
              ...
              <div className={styles.rcptFooter}>
                {clinic?.clinic_type === "store" ? "Thank you! Visit us again." : "Thank you! Wishing you a speedy recovery."}
              </div>
            </div>
