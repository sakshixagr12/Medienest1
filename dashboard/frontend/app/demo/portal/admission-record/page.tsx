...
function AdmissionRecordRedesign() {
  ...
  const [summary, setSummary] = useState<SummaryData>({
    ...
    date_admission: "", severity: "Mild", admission_type: "OPD",
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      if (patientId) {
        router.push(`/demo/portal/doctor-dashboard/patients/${patientId}${qs ? `?${qs}` : ""}`);
      } else {
        router.push(`/demo/portal/doctor-dashboard${qs ? `?${qs}` : ""}`);
      }
    } catch (e: any) {
              ...
              <div className={styles.stickyQuickActions}>
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (dName) params.set("doctorName", dName);
                    const qs = params.toString();
                    router.push(`/demo/portal/admission-record/summary${qs ? `?${qs}` : ""}`);
                  }}
