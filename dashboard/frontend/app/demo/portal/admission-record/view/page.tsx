          ...
          <button
            ...
            onClick={() => {
              if (record?.patient_id) {
                ...
                router.push(
                  `/demo/portal/doctor-dashboard/patients/${record.patient_id}?tab=Admissions${qs ? `&${qs}` : ""}`
                );
              } else {
                router.back();
              }
        ...
        <div className={styles.previewDoc}>
          <table className={styles.printableTable}>
            <thead>
              <tr>
                <td>
                  ...
                  <div className={styles.previewInfoGrid}>
                    <div>
                      <b>Patient Name:</b> {record.patient_name}
                    </div>
                    <div>
                      <b>Admission ID:</b> {record.id.slice(0, 8).toUpperCase()}
                    </div>
                    <div>
                      <b>Age / Sex:</b> {record.age_sex}
                    </div>
                    <div>
                    ...
                    <div>
                      <b>Ward / Bed:</b> {record.ward || "---"} /{" "}
                      {record.bed || "---"}
                    </div>
                    <div>
                      <b>Consultant:</b> Dr. {record.doctor_name || "---"}
                    </div>
                    <div>
                      <b>Admission Date:</b>{" "}
                      {new Date(record.date_admission).toLocaleString()}
                    </div>
                    <div>
                      <b>Admission Source:</b> {record.admission_type || "OPD"}
                    </div>
              ...
              {(record.allergies ||
                record.vitals_temp > 101 ||
                record.vitals_spo2 < 94) && (
                <tr>
                      ...
                      >
                        {record.allergies && (
                          <div style={{ fontSize: 13, color: "#ef4444" }}>
                            <b>ALLERGIES:</b> {record.allergies}
                          </div>
                        )}
                        {record.vitals_temp > 101 && (
                          <div style={{ fontSize: 13, color: "#b45309" }}>
                            <b>HIGH FEVER:</b> {record.vitals_temp}°F
                          </div>
                        )}
                        {record.vitals_spo2 < 94 && (
                          <div style={{ fontSize: 13, color: "#dc2626" }}>
                            <b>LOW SPO2:</b> {record.vitals_spo2}% (Urgent
                            Review Required)
                          </div>
                        )}
                      </div>
                  ...
                  >
                    <div>
                      ...
                      <div style={{ fontSize: 14, fontWeight: 700 }}>
                        {record.vitals_bp_sys}/{record.vitals_bp_dia}
                      </div>
                    </div>
                    <div>
                      <div
              ...
              <tr>
                <td>
                  ...
                  <div className={styles.previewSection}>
                    ...
                    >
                      {Array.isArray(record.complaints) &&
                        record.complaints.map((c: string, i: number) => (
                          <span
                            key={i}
                            style={{
                              background: "#f1f5f9",
                  ...
                  <div className={styles.previewSection}>
                    ...
                    >
                      {Array.isArray(record.findings) &&
                        record.findings.map((f: string, i: number) => (
                          <span
                            key={i}
                            style={{
                              background: "#f1f5f9",
                  ...
                  <div className={styles.previewSection}>
                    ...
                    >
                      {Array.isArray(record.investigations) &&
                        record.investigations.map((inv: any, i: number) => (
                          <div
                            key={i}
                            style={{
                              display: "flex",
