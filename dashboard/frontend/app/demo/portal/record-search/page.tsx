...
function RecordSearch() {
  ...
  const backHref = doctorId
    ? `/demo/portal/doctor-dashboard?doctorId=${doctorId}&doctorName=${encodeURIComponent(doctorName || "")}`
    : "/demo/portal/front-desk";
                ...
                <div key={record.id} className={styles.resultCard}>
                  ...
                  <div className={styles.resActions}>
                    <button
                      ...
                      onClick={() =>
                        router.push(
                          `/demo/portal/billing-receipts/view?id=${record.id}${getDoctorParams()}`,
                        )
                      }
                    >
                      View/Print
