          ...
          <div className={styles.queueLayout}>
                ...
                {serving ? (
                  <div className={styles.nowServingCard}>
                    ...
                    <div className={styles.nsActions}>
                      <Link
                        href={getDoctorUrl(`/demo/portal/doctor-dashboard/patients/${serving.patient_id}`)}
                        className={styles.btnOutline}
                      >
                        View Record
                      </Link>
                      <Link
                        href={getDoctorUrl(`/demo/portal/digital-prescription?patientId=${serving.patient_id}`)}
              ...
              {queue.length === 0 && !loading && (
                <div className={styles.emptyQueue}>
                  ...
                  <p>
                   ...
                   <Link
                    href={getDoctorUrl("/demo/portal/front-desk/queue-manager")}
                    className={styles.btnPrimary}
                    style={{ marginTop: 16 }}
                  >
                    Open Queue Manager
            ...
            <aside className={styles.sideCol}>
              ...
              <div className={styles.quickLinksCard}>
                ...
                <Link
                  href={getDoctorUrl("/demo/portal/digital-prescription")}
                ...
                <Link
                  href={getDoctorUrl("/demo/portal/doctor-dashboard/patients")}
                  className={styles.qlLink}
                >
                  <svg
                    width="16"
