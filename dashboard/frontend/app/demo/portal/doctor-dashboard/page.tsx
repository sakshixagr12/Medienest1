...
import DemoDashboardTour from "@/components/demo/DemoDashboardTour";
...
export default function DoctorPage() {
  ...
  return (
    <DashboardLayout>
      ...
      <div className={`${styles.dashboardHeader} ${styles.desktopOnly}`} data-tour="dashboard-header">
      ...
      <div className={styles.fullWidthLayout}>
        <div className={styles.mainCol}>
          ...
          <div className={`${styles.metricsRow} ${styles.desktopOnly}`} data-tour="metrics-row">
            {metrics.map((m) => (
              <div
                key={m.label}
                ...
                <div style={{ maxHeight: 340, overflowY: "auto" }}>
                  {todayPatients.map((p, idx) => (
                    ...
                    >
                      ...
                      {p.patient_id && (
                        <a
                          href={getDoctorUrl(`/demo/portal/doctor-dashboard/patients/${p.patient_id}`)}
                          style={{
                            fontSize: 12,
                            fontWeight: 700,
                            color: "var(--sanctuary-primary)",
          ...
          {/* Active Queue */}
          <div className={styles.sectionBox} data-tour="active-queue">
            ...
            {liveQueue.length === 0 ? (
              ...
              <div className={styles.activeQueue}>
                ...
                {nowServing && (
                  <div className={styles.nowServingCard} data-tour="now-serving">
                    ...
                    >
                      ...
                      <Link
                        href={`/demo/portal/digital-prescription?patientId=${nowServing.patient_id}&doctorName=${activeDoctorName}&ptName=${encodeURIComponent(nowServing.patients?.name || "")}&ptPhone=${nowServing.patients?.contact || ""}&ptAge=${nowServing.patients?.age || ""}&ptSex=${nowServing.patients?.gender || "Male"}&ptBloodGroup=${nowServing.patients?.blood_group || ""}${doctorId ? `&doctorId=${doctorId}` : ""}`}
                        style={{
                          textDecoration: "none",
                          display: "flex",
                          alignItems: "center",
                      ...
                      >
                        <Link
                          href={getDoctorUrl(`/demo/portal/doctor-dashboard/patients/${nowServing.patient_id}`)}
                ...
                {waitingList.length > 0 && (
                  <div className={styles.waitingSection} data-tour="waiting-list">
                    <div className={styles.queueBadgeRow}>
                      ...
                      {waitingList.slice(0, 3).map((p, idx) => (
                        <div key={p.id} className={styles.waitingItem}>
                          ...
                          <div style={{ display: "flex", gap: "8px" }}>
                            ...
                            <Link
                              href={`/demo/portal/digital-prescription?patientId=${p.patient_id}&doctorName=${activeDoctorName}&ptName=${encodeURIComponent(p.patients?.name || "")}&ptPhone=${p.patients?.contact || ""}&ptAge=${p.patients?.age || ""}&ptSex=${p.patients?.gender || "Male"}&ptBloodGroup=${p.patients?.blood_group || ""}${doctorId ? `&doctorId=${doctorId}` : ""}`}
                              className={styles.waitingViewBtn}
        ...
        {/* ── Clinical Analytics ── */}
        <div style={{ marginTop: 4 }} data-tour="clinical-intelligence">
