...
import RecruiterPresentation from "@/components/demo/RecruiterPresentation";
...
export default function PortalPage() {
  ...
  useEffect(() => {
    if (searchParams.get("showPresentation") === "true") {
    ...
    <>
      ...
      <div className={styles.page}>
        ...
        <main className={styles.selectionShell}>
          ...
          <Link href="/demo/portal/front-desk" className={styles.portalCardLarge} data-tour="front-desk">
            <div className={styles.cardContent}>
          ...
          <Link href="/demo/portal/billing-receipts" className={styles.portalCardLarge} data-tour="billing">
            <div className={styles.cardContent}>
          ...
          <Link href="/demo/portal/clinic-settings" className={styles.portalCardLarge} data-tour="settings">
            <div className={styles.cardContent}>
                ...
                <>
                  ...
                  <div className={styles.doctorList}>
                    {doctors.map((doc, idx) => (
                      <Link
                        key={doc.id}
                        href={`/demo/portal/doctor-dashboard?doctorId=${doc.doctor_id || doc.id}&doctorName=${encodeURIComponent(doc.name)}`}
        ...
        <section className={styles.activityFeed}>
          <div className={styles.activityHeader}>
            ...
            <Link href="/demo/portal/front-desk/analytics" className={styles.viewAllLink}>
      ...
      {showPresentation && (
        <RecruiterPresentation onClose={handleClosePresentation} />
      )}
    </>
  );
}
