        ...
        <div className={styles.header}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            ...
            <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
              <Link href="/demo/portal/doctor-dashboard" className={styles.btnSecondary} style={{ display: "flex", alignItems: "center", gap: "8px", textDecoration: "none", padding: "12px 24px", fontSize: "15px", height: "46.5px" }}>
