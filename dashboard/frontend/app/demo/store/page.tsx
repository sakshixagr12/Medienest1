    ...
    <>
      ...
      <div className={styles.page}>
        ...
        <main className={styles.selectionShell} style={{ gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "24px" }}>
          <Link href="/demo/store/billing-receipts" className={styles.portalCardLarge}>
          ...
          <Link href="/demo/store/day-summary" className={styles.portalCardLarge}>
            <div className={styles.cardContent}>
          ...
          <Link href="/demo/store/clinic-settings" className={styles.portalCardLarge}>
            <div className={styles.cardContent}>
