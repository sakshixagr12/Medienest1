...
import { User, FileText, Users, Hospital, Sparkles } from "lucide-react";
...
function AuthPageContent() {
  ...
  const handleQuickLogin = async () => {
    ...
    setAuthLoading(true);
    try {
      console.log(`Auth: Initiating Quick Demo Login...`);
          ...
          <main className={styles.authCard}>
            ...
            <div className={styles.panelContent}>
              ...
              <p className={styles.cardSubtext}>
                {tab === "register"
                  ? "Explore the platform instantly or create a new account using Google."
                  : "Explore the platform instantly or sign in using Google."}
              </p>
              ...
              >
                {authLoading ? (
                  ...
                  <>
                    ...
                    {tab === "register" ? "Sign up with Google (Simulated)" : "Continue with Google (Simulated)"}
                  </>
                )}
              </button>
              ...
              <div className={styles.consentTermsCheckbox}>
                <label className={styles.checkboxLabel}>
                  ...
                  <span className={styles.checkboxText}>
                    I agree to the <Link href="/demo/terms" className={styles.blueLink}>Terms of Service</Link> and <Link href="/demo/privacy" className={styles.blueLink}>Privacy Policy</Link>
                  </span>
                </label>
              </div>
              ...
              <div className={styles.toggleTextRow}>
                {tab === "register" ? (
                  <span>
                    ...
                    <Link href="/demo/auth?tab=login" className={styles.blueLink}>
                      Sign in &gt;
                    </Link>
                  </span>
                ) : (
                  <span>
                    New to MedieNest?{" "}
                    <Link href="/demo/auth?tab=register" className={styles.blueLink}>
                      Create an account &gt;
                    </Link>
                  </span>
                )}
              ...
              <footer className={styles.footerLinks}>
                ...
                <Link href="/demo/terms">Terms of Service</Link>
                <span className={styles.dotSeparator}>•</span>
