...
export default function LandingPage() {
  ...
  return (
    <div className="landing-root">
      ...
      <nav className={`glass-nav ${scrolled ? "scrolled" : ""} ${mobileMenuOpen ? "menu-open" : ""}`}>
        <div className="container nav-container">
          ...
          <div className="nav-links">
            ...
            <Link href="/demo/support" className="nav-link-white">FAQ</Link>
          </div>

          <div className="nav-actions desktop-actions">
            <Link href="/demo/auth?tab=login" className="btn-login-secondary">Login</Link>
            <Link href="/demo/auth?tab=register" className="btn-premium pulse-premium">Start Free Trial</Link>
          </div>

          <div className="mobile-actions">
            <Link href="/demo/auth?tab=login" className="mobile-login-text">Login</Link>
            <button
        ...
        {mobileMenuOpen && (
          <div className="mobile-menu">
            ...
            <Link href="/demo/support" className="mobile-menu-link" onClick={() => setMobileMenuOpen(false)}>FAQ</Link>
            <div className="mobile-menu-divider"></div>
            <Link href="/demo/auth?tab=login" className="mobile-menu-login" onClick={() => setMobileMenuOpen(false)}>Login</Link>
          </div>
        )}
      </nav>
          ...
          <div className="hero-grid">
            ...
            >
              ...
              <div className="dedicated-hero-btns">
                <Link href="/demo/auth?tab=register" className="btn-premium pulse-premium dedicated-btn" style={{ padding: '1.15rem 1.5rem', fontSize: '1.1rem' }}>
      ...
      <section className="section-v3" id="pricing" ref={pricingSectionRef}>
        <div className="container center">
          ...
          <div className="pricing-grid-v5">
            <Link href="/demo/auth?tab=register" className="price-card-link">
      ...
      <section className="final-cta-v5">
        <div className="container center">
          <div className="final-cta-box">
            ...
            <Link href="/demo/auth?tab=register" className="btn-premium pulse-premium shadow-wa" style={{ padding: "1.25rem 3rem", fontSize: "1.25rem" }}>Get Started Now</Link>
          </div>
        </div>
      </section>
      ...
      {/* Recruiter walkthrough demo invitation popup */}
      {showDemoModal && (
        <div style={{
          position: "fixed",
          top: 0,
          ...
          <div style={{
            ...
            width: "100%",
            maxWidth: "500px",
            background: "linear-gradient(135deg, rgba(26, 11, 56, 0.95) 0%, rgba(13, 5, 30, 0.98) 100%)",
            borderRadius: "24px",
            border: "1px solid rgba(255, 255, 255, 0.1)",
            boxShadow: "0 25px 50px -12px rgba(0, 0, 0, 0.6), 0 0 40px rgba(13, 148, 136, 0.25)",
            ...
            <div style={{
              ...
              height: "72px",
              borderRadius: "20px",
              background: "linear-gradient(135deg, rgba(13, 148, 136, 0.25) 0%, rgba(16, 185, 129, 0.12) 100%)",
            ...
            <p style={{
              ...
              Explore the platform instantly using our walkthrough demo. Equipped with pre-loaded mock scenarios, it requires no real credentials or configuration.
            </p>
            ...
            <div style={{
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = "0 12px 24px -5px rgba(13, 148, 136, 0.5)";
                }}
                onMouseLeave={(e) => {
              ...
              >
                <span>Enter Demo Portal (Instant)</span>
                <ArrowRight size={18} />
              </button>
