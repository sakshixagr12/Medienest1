  ...
  if (loading) {
    return (
      <div className={styles.page}>
        <TopBar title="View Receipt" backHref="/demo1/store/billing-receipts" />
      ...
      <div className={styles.page}>
        ...
        <div className={styles.errorArea}>
          ...
          <button
            ...
            onClick={() => router.push("/demo1/store/billing-receipts")}
          >
            Back to Billing
          </button>
        </div>
  ...
  return (
    <div className={styles.page}>
      <TopBar
        ...
        backHref="/demo1/store/billing-receipts"
      />
        ...
        <div className={styles.container}>
          <div className={styles.receiptCard} id="receipt-print-area">
            <div className={styles.rcptHeader}>
              <h2>{clinic?.name || "MedieNest Clinic"}</h2>
            ...
            <div className={styles.rcptInfo}>
              ...
              {receipt.doctor_name && (
                ...
                >
                  <span>{clinic?.clinic_type === "store" ? "Prescribed By:" : "Consultant:"}</span> <b>{receipt.doctor_name}</b>
                </div>
              )}
            </div>
