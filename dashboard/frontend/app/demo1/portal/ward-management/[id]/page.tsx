  ...
  if (isLoading) {
    return (
      <div className="pageWrapper" style={{ minHeight: "100vh", background: "var(--sanctuary-bg)" }}>
        <TopBar title="Ward Details" backHref="/demo1/portal/ward-management" />
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <div className={styles.headerActions}>
            <Link href="/demo1/portal/bed-management" className={styles.btnAddBed}>
        ...
        {beds.length === 0 ? (
          <div className={styles.emptyState}>
            ...
            <Link href="/demo1/portal/bed-management" style={{ color: "#3b82f6", textDecoration: "none", marginTop: "8px", display: "inline-block" }}>Go to Bed Management to add beds.</Link>
          </div>
        ) : (
