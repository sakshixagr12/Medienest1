...
function PatientLobbyContent() {
  ...
  const confirmCheckIn = async () => {
    ...
    try {
      ...
      router.push("/demo1/portal/front-desk");
    } catch (err: any) {
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          <div className={styles.headerTitle}>
            <h1>Patient Lobby</h1>
            <p>
              Find registered patients and add them to today&apos;s waiting
              list.
            </p>
          </div>
          <button
            ...
            onClick={() => router.push("/demo1/portal/front-desk/register-patient")}
          >
              ...
              <div key={p.id} className={styles.patientCard}>
                ...
                <div className={styles.actionArea}>
                  ...
                  <button
                    ...
                    onClick={() =>
                      router.push(
                        `/demo1/portal/record-search?q=${p.contact || p.name}`,
                      )
                    }
                  >
                    <svg
