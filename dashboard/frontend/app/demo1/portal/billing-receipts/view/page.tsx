  ...
  if (loading) {
    return (
      <div className={styles.page}>
        <TopBar title="View Receipt" backHref={`/demo1/portal/record-search${getDoctorParamsForSearch()}`} />
      ...
      <div className={styles.page}>
        ...
        <div className={styles.errorArea}>
          ...
          <button
            ...
            onClick={() => router.push(`/demo1/portal/record-search${getDoctorParamsForSearch()}`)}
          >
            Back to Search
          </button>
        </div>
  ...
  return (
    <div className={styles.page}>
      <TopBar
        ...
        backHref={`/demo1/portal/record-search${getDoctorParamsForSearch()}`}
      />
