        ...
        <div className={styles.header}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            ...
            <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
              <Link href="/demo1/portal/doctor-dashboard" className={styles.btnSecondary} style={{ display: "flex", alignItems: "center", gap: "8px", textDecoration: "none", padding: "12px 24px", fontSize: "15px", height: "46.5px" }}>
                            ...
                            <td>
                              <div className={styles.actionsContainer}>
                                <button
                                  ...
                                  onClick={() => router.push(`/demo1/portal/admission-workspace/${record.id}`)}
                                >
                                  Manage Workspace
                                </button>
                              </div>
                          ...
                          <tr key={record.id}>
                            ...
                            <td>
                              <div className={styles.actionsContainer}>
                                <button
                                  className={styles.btnAction}
                                  onClick={() => router.push(`/demo1/portal/admission-record?draftId=${record.id}&patientId=${record.patient_id}`)}
                                >
                                  Resume Draft
                                </button>
                                <button
