        ...
        <div className={styles.rightColumn}>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.quickActions}>
              <Link 
                href={`/demo1/portal/admission-record?draftId=${record.id}&patientId=${record.patient_id || ""}`} 
              ...
              {record.status?.toUpperCase() === "ADMITTED" ? (
                <Link 
                  href={`/demo1/portal/discharge-summary?admissionId=${record.id}&patientId=${record.patient_id || ""}`} 
              ...
              <Link 
                href={`/demo1/portal/admission-record/view?id=${record.id}`} 
                target="_blank"
