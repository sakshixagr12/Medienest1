            ...
            <tr key={i}>
              ...
              <td>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  <Link
                    href={`/demo1/portal/discharge-summary/view?id=${s.id}${getDoctorParams()}`}
          ...
          {admissions.map((a, i) => (
            <tr key={i}>
              ...
              <td>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  <Link
                    href={`/demo1/portal/admission-record/view?id=${a.id}${getDoctorParams()}`}
                    className={styles.tableAction}
                  >
                    <svg
                      width="14"
            ...
            <div className={styles.actionGroup}>
              <button
                ...
                onClick={() => {
                  ...
                  const qs = p.toString();
                  router.push(`/demo1/portal/digital-prescription${qs ? `?${qs}` : ""}`);
                }}
              >
                <svg
                  width="18"
              ...
              <Link 
                href={`/demo1/portal/doctor-dashboard/patients/${patientId}/export${getDoctorParams()}`} 
                target="_blank" 
