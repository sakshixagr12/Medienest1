...
export default function SettingsPage() {
  ...
  return (
    <div className={styles.page}>
      <TopBar title="Clinic Settings" backHref="/demo1/portal/front-desk" />
      ...
      <main className={styles.main}>
        ...
        <button className={styles.saveBtn} onClick={saveClinicProfile}>
      ...
      {/* Bottom Sheet Modal */}
      <div
        className={`${styles.overlay} ${isSheetOpen ? styles.overlayOpen : ""}`}
      ...
      <div className={`${styles.sheet} ${isSheetOpen ? styles.sheetOpen : ""}`}>
        ...
        <button className={styles.sheetSave} onClick={saveService}>
          Add Service
        </button>
        <button
