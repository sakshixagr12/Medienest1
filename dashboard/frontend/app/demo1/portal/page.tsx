    ...
    <>
      ...
      <div className={styles.page}>
        ...
        <main className={styles.selectionShell}>
          ...
          <Link href="/demo1/portal/front-desk" className={styles.portalCardLarge}>
            <div className={styles.cardContent}>
          ...
          <Link href="/demo1/portal/billing-receipts" className={styles.portalCardLarge}>
            <div className={styles.cardContent}>
          ...
          <Link href="/demo1/portal/clinic-settings" className={styles.portalCardLarge}>
            <div className={styles.cardContent}>
                ...
                <>
                  ...
                  <div className={styles.doctorList}>
                    {doctors.map((doc, idx) => (
                      <Link
                        key={doc.id}
                        href={`/demo1/portal/doctor-dashboard?doctorId=${doc.doctor_id || doc.id}&doctorName=${encodeURIComponent(doc.name)}`}
        ...
        <section className={styles.activityFeed}>
          <div className={styles.activityHeader}>
            ...
            <Link href="/demo1/portal/front-desk/analytics" className={styles.viewAllLink}>
