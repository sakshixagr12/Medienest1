    ...
    <div className="landing-root">
      ...
      <nav className={`glass-nav ${scrolled ? "scrolled" : ""} ${mobileMenuOpen ? "menu-open" : ""}`}>
        <div className="container nav-container">
          <Link href="/demo1" className="logo">
            <Image
              src="/assets/medienest_logo.png"
              alt="MedieNest"
              width={42}
          ...
          <div className="nav-links">
            ...
            <Link href="/demo1/support" className="nav-link-white">FAQ</Link>
          </div>

          <div className="nav-actions desktop-actions">
            <Link href="/demo1/auth?tab=login" className="btn-login-secondary">Login</Link>
            <Link href="/demo1/auth?tab=register" className="btn-premium pulse-premium">Start Free Trial</Link>
          </div>

          <div className="mobile-actions">
            <Link href="/demo1/auth?tab=login" className="mobile-login-text">Login</Link>
            <button
        ...
        {mobileMenuOpen && (
          <div className="mobile-menu">
            ...
            <Link href="/demo1/support" className="mobile-menu-link" onClick={() => setMobileMenuOpen(false)}>FAQ</Link>
            <div className="mobile-menu-divider"></div>
            <Link href="/demo1/auth?tab=login" className="mobile-menu-login" onClick={() => setMobileMenuOpen(false)}>Login</Link>
          </div>
        )}
      </nav>
          ...
          <div className="hero-grid">
            ...
            >
              ...
              <div className="dedicated-hero-btns">
                <Link href="/demo1/auth?tab=register" className="btn-premium pulse-premium dedicated-btn" style={{ padding: '1.15rem 1.5rem', fontSize: '1.1rem' }}>
      ...
      <section className="section-v3" id="pricing" ref={pricingSectionRef}>
        <div className="container center">
          ...
          <div className="pricing-grid-v5">
            <Link href="/demo1/auth?tab=register" className="price-card-link">
      ...
      <section className="final-cta-v5">
        <div className="container center">
          <div className="final-cta-box">
            ...
            <Link href="/demo1/auth?tab=register" className="btn-premium pulse-premium shadow-wa" style={{ padding: "1.25rem 3rem", fontSize: "1.25rem" }}>Get Started Now</Link>
          </div>
        </div>
      </section>
