          ...
          <main className={styles.authCard}>
            ...
            <div className={styles.panelContent}>
              ...
              <div className={styles.consentTermsCheckbox}>
                <label className={styles.checkboxLabel}>
                  ...
                  <span className={styles.checkboxText}>
                    I agree to the <Link href="/demo1/terms" className={styles.blueLink}>Terms of Service</Link> and <Link href="/demo1/privacy" className={styles.blueLink}>Privacy Policy</Link>
                  </span>
                </label>
              </div>
              ...
              <div className={styles.toggleTextRow}>
                {tab === "register" ? (
                  <span>
                    ...
                    <Link href="/demo1/auth?tab=login" className={styles.blueLink}>
                      Sign in &gt;
                    </Link>
                  </span>
                ) : (
                  <span>
                    New to MedieNest?{" "}
                    <Link href="/demo1/auth?tab=register" className={styles.blueLink}>
                      Create an account &gt;
                    </Link>
                  </span>
                )}
              ...
              <footer className={styles.footerLinks}>
                <Link href="/demo1/privacy">Privacy Policy</Link>
                <span className={styles.dotSeparator}>•</span>
                <Link href="/demo1/terms">Terms of Service</Link>
                <span className={styles.dotSeparator}>•</span>
                <Link href="/demo1/support">Contact Support</Link>
              </footer>
            </div>
          </main>
        </div>
